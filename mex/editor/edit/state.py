...
from mex.editor.edit.fields import NEVER_EDITABLE_FIELDS
...
class EditState(State):
    ...
    debug_rule_set: str = ""
    never_editable_fields: list[str] = NEVER_EDITABLE_FIELDS
    ...
    def refresh(self) -> EventSpec | None:
        ...
        self.stem_type = transform_models_to_stem_type(response.items)
